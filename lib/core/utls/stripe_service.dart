...
import 'package:payment/core/utls/api_service.dart';
...
class StripeService {
  ...
  Future initPaymenSheet({required InitPaymentIntentInputModel initPaymentIntentInputModel}) async {
   await Stripe.instance.initPaymentSheet(
        paymentSheetParameters: SetupPaymentSheetParameters(
      paymentIntentClientSecret:initPaymentIntentInputModel.paymentIntentClientSecret,
      customerEphemeralKeySecret:initPaymentIntentInputModel.customerEphemeralKeySecret ,
...
var ephemeralKeyModel= await createEphemeralKey(customerId: paymentIntentInputModel.customerId);
    var initPaymentIntentInputModel=InitPaymentIntentInputModel(customerId: paymentIntentInputModel.customerId, paymentIntentClientSecret: paymentIntentModel.clientSecret!, customerEphemeralKeySecret: ephemeralKeyModel.secret!);
